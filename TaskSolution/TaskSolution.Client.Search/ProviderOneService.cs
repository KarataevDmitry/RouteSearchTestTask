...
namespace ProviderOneReader
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ProviderOneClient 
    {
        private string _baseUrl = "http://localhost:4883/";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public ProviderOneClient(System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = _baseUrl;
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TravelRoute>> GetAllAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TravelRoute>> GetAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/TravelRoutes/getAll");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TravelRoute>>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class TravelRoute
    {
        ...
        [Newtonsoft.Json.JsonProperty("startDateTimeUTC", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset StartDateTimeUTC { get; set; }

        [Newtonsoft.Json.JsonProperty("arrivalDateTimeUTC", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset ArrivalDateTimeUTC { get; set; }

        [Newtonsoft.Json.JsonProperty("timeToLive", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
